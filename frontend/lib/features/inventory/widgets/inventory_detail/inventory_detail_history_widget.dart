...
import 'package:frontend/features/inventory/models/inventory_history_model.dart'; // THÊM IMPORT NÀY
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        // FIX: Đã sử dụng Model
        final item = controller.inventoryHistory[index];

        final isOut = item.type == InventoryActionType.out;
