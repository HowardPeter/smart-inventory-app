...
import 'package:frontend/features/workspace/widgets/create_store/create_store_app_bar_widget.dart';
...
class CreateStoreMobileView extends GetView<CreateStoreController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CreateStoreAppBarWidget(), // <-- Gọi Widget AppBar
